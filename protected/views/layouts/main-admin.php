            ...
            <div class="well sidebar-nav">
				<?php
					...
					'items' => array(
						...
						array('label' => tt('Vacancy', 'vacancy'), 'visible' => Yii::app()->user->checkAccess('vacancy_admin')),
						array('label' => tt('Vacancy_management', 'vacancy') . $bageVacancy, 'icon' => 'icon-list-alt', 'url' => $baseUrl . '/vacancy/backend/main/admin', 'active' => isActive('vacancy'), 'visible' => Yii::app()->user->checkAccess('vacancy_admin')),
						array('label' => tt('Add_feedback', 'vacancy'), 'icon' => 'icon-plus-sign', 'url' => $baseUrl . '/vacancy/backend/main/create', 'active' => isActive('vacancy.create'), 'visible' => Yii::app()->user->checkAccess('vacancy_admin')),
						...
						array('label' => tc('Blog'), 'icon' => 'icon-file', 'url' => $baseUrl . '/blog/backend/main/admin', 'active' => isActive('blog'), 'visible' => Yii::app()->user->checkAccess('blog_admin')),
