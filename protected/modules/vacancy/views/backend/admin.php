...
$this->widget('CustomGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name' => 'active',
			'type' => 'raw',
			'value' => 'Yii::app()->controller->returnStatusHtml($data, "vacancy-grid", 1)',
		...
		array (
			...
			'sortable' => false,
			'type' => 'raw',
			'value' => 'CHtml::link(CHtml::encode(truncateText($data->body)),array("/vacancy/backend/main/view","id" => $data->id))',
		),
		array (
			'name' => 'date_created',
		...
		array(
			...
			'viewButtonUrl' => "Yii::app()->createUrl('/vacancy/backend/main/view', array('id' => \$data->id))",
...
$this->renderPartial('//site/admin-select-items', array(
	'url' => '/vacancy/backend/main/itemsSelected',
	'id' => 'vacancy-grid',
	'model' => $model,
	'options' => array(
