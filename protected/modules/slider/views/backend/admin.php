...
<?php $this->widget('CustomGridView', array(
	...
	'afterAjaxUpdate' => 'function(){$("a[rel=\'tooltip\']").tooltip(); $("div.tooltip-arrow").remove(); $("div.tooltip-inner").remove(); $("a.fancy").fancybox({"ajax":{"data": {"isFancy":"true"}}}); reInstallSortable();}',
	...
	'columns'=>array(
		...
		array(
			'name'=>'url',
			'type'=>'raw',
			'value' => '$data->url?CHtml::link(tt("Link"), $data->url):""',
			'sortable' => false,
		),
		array(
			//'class'=>'CButtonColumn',
