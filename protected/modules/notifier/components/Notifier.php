    ...
    public function init() {
        ...
        $this->_adminRules = array(
            ...
            'onNewContactform' => array(
                'fields' => array('name', 'email', 'phone', 'theme', 'body'),
    ...
    private function _processEvent($rule, $model, $to, $toModerators = false) {
        ...
        if ($body) {
            ...
            if (param('mailUseSMTP', 0)) {
                ...
                $mailer->Host = param('mailSMTPHost', 'https://www.unisender.com/ru/');
                $mailer->Port = param('mailSMTPPort', 25);

                $mailer->Username = param('mailSMTPLogin','raui.ru');  // SMTP login
                $mailer->Password = param('mailSMTPPass','www123www'); // SMTP password
