<div class="form">
	...
	<div class="rowold">
		...
		<?php
			echo $form->listBox($model, 'areas', $areas, array('class'=>'width300', 'size' => 16, 'multiple'=>'multiple'));
		?>
	...
	<div class="hidden" id="file">
		<div class="rowold">
			...
			<?php echo '<span class="label label-info">'.Yii::t('module_advertising', 'Supported file: {supportExt}.', array('{supportExt}' => $model->supportExt)).'</span>';?>
