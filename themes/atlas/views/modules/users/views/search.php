	...
	<?php if ($dataProvider && isset($dataProvider->data) && $dataProvider->data):?>
		<?php
			$this->widget('zii.widgets.CListView',
				...
				'itemView'=>'_bt_search_user_item', // представление для одной записи
				'ajaxUpdate'=>false, // отключаем ajax поведение
				'emptyText'=>false,
				'summaryText'=>"{start}&mdash;{end} ".tc('of')." {count}",
			//	'template'=>'{summary} {sorter} {items} <div class="clear"></div><br /> {pager}', Для всех
				'template'=>'<div id="slider-best-agency" class="carousel slide"><div class="carousel-inner">{items}</div></div>',
