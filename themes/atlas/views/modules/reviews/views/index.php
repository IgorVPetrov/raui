...
<h1 class="title highlight-left-right">
	<span><?php echo ReviewsModule::t('Reviews'); ?></span>
</h1>
<div class="clear"></div><br />

<?php if(count($reviews) > 3){ ?>
<div class="add-review-link">
	<?php echo CHtml::link(tt('Add_feedback', 'reviews'), Yii::app()->createUrl('/reviews/main/add'), array('class' => 'apt_btn fancy link_blue'));?>
</div>
<?php } ?>
